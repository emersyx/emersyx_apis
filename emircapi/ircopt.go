...
// needs to also provide a related IRCOptions implementation. Different IRCOptions implementations may not be compatible
// with the same IRCBot implementation.
